...
from processors.text_processors import NullTextProcessor, DeepSeekTextProcessor
...
class ProcessorRegistry:
    ...
    def _register_default_processors(self):
        ...
        self.register_processor(DocumentProcessor(text_processor=DeepSeekTextProcessor()))
        self.register_processor(PDFProcessor(text_processor=DeepSeekTextProcessor()))
        self.register_processor(ImageProcessor(text_processor=DeepSeekTextProcessor()))
        self.register_processor(HTMLProcessor(text_processor=DeepSeekTextProcessor()))
